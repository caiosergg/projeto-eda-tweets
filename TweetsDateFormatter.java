...
public class TweetsDateFormatter {
    public static void main(String[] args) throws Exception {
        BufferedReader reader = new BufferedReader(new FileReader("data/tweets.csv"));
        BufferedWriter writer = new BufferedWriter(new FileWriter("data/tweets_formated_data.csv"));
